...
import sys
sys.path.append('/home/wjx/paper/DFSP-main/')
from clip_modules.model_loader import load

# from dataset.composition_dataset import CompositionDataset
from dataset import CompositionDataset
# from dataset.read_datasets import DATASET_PATHS

# DIR_PATH = os.path.dirname(os.path.realpath(__file__))
DIR_PATH = '/home/wjx/paper/DFSP-main/'
